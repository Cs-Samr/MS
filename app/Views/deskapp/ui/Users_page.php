  ...
  <div class="pd-20 d-flex align-items-center justify-content-between">
    ...
    <thead>
                <tr role="row">
                    ...
                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="department: activate to sort column ascending">Department</th>
                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Employee_No: activate to sort column ascending">Employee_No</th>
                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Email Date: activate to sort column ascending">Email</th>
                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Job Type Date: activate to sort column ascending">Job Type</th>
                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Rules Date: activate to sort column ascending">Rules</th>
            ...
            <tbody>
                <?php foreach ($users as $user) : ?>
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                        <a class="dropdown-item"  href="http://localhost/MS/deskapp/ui/edit/<?= $user['id_mem'] ?>"><i class="dw dw-edit2"></i> Edit</a>
                        <a class="dropdown-item delete-user" href="http://localhost/MS/deskapp/ui/delete/<?= $user['id_mem'] ?>"><i class="dw dw-delete-3"></i> Delete</a>
                    </div>
                            </div>
                        </td>
                    </tr>
