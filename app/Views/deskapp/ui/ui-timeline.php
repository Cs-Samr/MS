...
<html data-select2-id="14"><head>
    ...
    #td-clock-3 .td-clock .td-time span.on {
        color: #1977CC
    }

    #td-clock-3 .td-clock:before {
        border-color: #1977CC
    }

    #td-clock-3 .td-select:after {
        box-shadow: 0 0 0 1px #1977CC
    }
    ...
    #td-clock-3 .td-lancette {
        border: 2px solid #1977CC;
        opacity: 0.1
    }

    #td-clock-3 .td-lancette div:after {
        background: #1977CC;
    }

    #td-clock-3 .td-bulletpoint div:after {
        background: #1977CC;
        opacity: 0.1
    }
    </style>
    ...
    #td-clock-4 .td-clock .td-time span.on {
        color: #1977CC
    }

    #td-clock-4 .td-clock:before {
        border-color: #1977CC
    }

    #td-clock-4 .td-select:after {
        box-shadow: 0 0 0 1px #1977CC
    }
    ...
    #td-clock-4 .td-lancette {
        border: 2px solid #1977CC;
        opacity: 0.1
    }

    #td-clock-4 .td-lancette div:after {
        background: #1977CC;
    }

    #td-clock-4 .td-bulletpoint div:after {
        background: #1977CC;
        opacity: 0.1
    }
    </style>
    ...
    #td-clock-5 .td-clock .td-time span.on {
        color: #1977CC
    }

    #td-clock-5 .td-clock:before {
        border-color: #1977CC
    }

    #td-clock-5 .td-select:after {
        box-shadow: 0 0 0 1px #1977CC
    }
    ...
    #td-clock-5 .td-lancette {
        border: 2px solid #1977CC;
        opacity: 0.1
    }

    #td-clock-5 .td-lancette div:after {
        background: #1977CC;
    }

    #td-clock-5 .td-bulletpoint div:after {
        background: #1977CC;
        opacity: 0.1
    }
    </style>
    ...
    #td-clock-6 .td-clock .td-time span.on {
        color: #1977CC
    }

    #td-clock-6 .td-clock:before {
        border-color: #1977CC
    }

    #td-clock-6 .td-select:after {
        box-shadow: 0 0 0 1px #1977CC
    }
    ...
    #td-clock-6 .td-lancette {
        border: 2px solid #1977CC;
        opacity: 0.1
    }

    #td-clock-6 .td-lancette div:after {
        background: #1977CC;
    }

    #td-clock-6 .td-bulletpoint div:after {
        background: #1977CC;
        opacity: 0.1
    }
    </style>
    ...
    #td-clock-7 .td-clock .td-time span.on {
        color: #1977CC
    }

    #td-clock-7 .td-clock:before {
        border-color: #1977CC
    }

    #td-clock-7 .td-select:after {
        box-shadow: 0 0 0 1px #1977CC
    }
    ...
    #td-clock-7 .td-lancette {
        border: 2px solid #1977CC;
        opacity: 0.1
    }

    #td-clock-7 .td-lancette div:after {
        background: #1977CC;
    }

    #td-clock-7 .td-bulletpoint div:after {
        background: #1977CC;
        opacity: 0.1
    }
    </style>
    ...
    #td-clock-8 .td-clock .td-time span.on {
        color: #1977CC
    }

    #td-clock-8 .td-clock:before {
        border-color: #1977CC
    }

    #td-clock-8 .td-select:after {
        box-shadow: 0 0 0 1px #1977CC
    }
    ...
    #td-clock-8 .td-lancette {
        border: 2px solid #1977CC;
        opacity: 0.1
    }

    #td-clock-8 .td-lancette div:after {
        background: #1977CC;
    }

    #td-clock-8 .td-bulletpoint div:after {
        background: #1977CC;
        opacity: 0.1
    }
    </style>
    ...
    #td-clock-9 .td-clock .td-time span.on {
        color: #1977CC
    }

    #td-clock-9 .td-clock:before {
        border-color: #1977CC
    }

    #td-clock-9 .td-select:after {
        box-shadow: 0 0 0 1px #1977CC
    }
    ...
    #td-clock-9 .td-lancette {
        border: 2px solid #1977CC;
        opacity: 0.1
    }

    #td-clock-9 .td-lancette div:after {
        background: #1977CC;
    }

    #td-clock-9 .td-bulletpoint div:after {
        background: #1977CC;
        opacity: 0.1
    }
    </style>
...
<body data-gr-ext-installed="" data-new-gr-c-s-check-loaded="14.1117.0" data-select2-id="13" class="header-white active sidebar-dark">
                                                                                                        ...
                                                                                                        <div id="mCSB_2_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="position:relative; top:0; left:0;" dir="ltr">
                                                                                                            <div id="mCSB_2" class="mCustomScrollBox mCS-dark-2 mCSB_vertical mCSB_inside" style="max-height: none;" tabindex="0">
                                                                                                                ...
                                                                                                                <div id="mCSB_2_scrollbar_vertical" class="mCSB_scrollTools mCSB_2_scrollbar mCS-dark-2 mCSB_scrollTools_vertical mCSB_scrollTools_onDrag_expand" style="display: none;">
                                                                                                                    <div class="mCSB_draggerContainer">
                                                                                                                        <div id="mCSB_2_dragger_vertical" class="mCSB_dragger" style="position: absolute; min-height: 0px; height: 0px; top: 0px; display: block; max-height: 593.792px;">
                                                                                                        ...
                                                                                                        <div id="mCSB_3_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="position:relative; top:0; left:0;" dir="ltr">
                                                                                                            <div id="mCSB_3" class="mCustomScrollBox mCS-dark-2 mCSB_vertical mCSB_inside" style="max-height: none;" tabindex="0">
                                                                                                                <div id="mCSB_3_container" class="mCSB_container" style="position:relative; top:0; left:0;" dir="ltr">
                                                                                                                    <div class="sidebar-menu icon-style-2 icon-list-style-1">
                                                                                                                        <ul id="accordion-menu">
                                                                                                                            ...
                                                                                                                            <li class="dropdown">
                                                                                                                                <a href="javascript:;" class="dropdown-toggle" data-option="off">
                                                                                                                                    <span class="micon dw dw-apartment"></span><span class="mtext">
                                                                                                                                        UI
                                                                                                                                        Elements
                                                                                                                                    </span>
                                                                                                                                </a>
                                                                                                                            ...
                                                                                                                            <li class="dropdown">
                                                                                                                                <a href="javascript:;" class="dropdown-toggle" data-option="off">
                                                                                                                                    <span class="micon dw dw-copy"></span><span class="mtext">Extra
                                                                                                                                        Pages</span>
                                                                                                                                </a>
                                                                                                                                <ul class="submenu">
                                                                                                                            ...
                                                                                                                            <li class="dropdown">
                                                                                                                                <a href="javascript:;" class="dropdown-toggle" data-option="off">
                                                                                                                                    <span class="micon dw dw-list3"></span><span class="mtext">Multi
                                                                                                                                        Level
                                                                                                                                        Menu</span>
                                                                                                                                </a>
                                                                                                                                <ul class="submenu">
                                                                                                                                    <li><a href="javascript:;">Level
                                                                                                                                            1</a>
                                                                                                                                    </li>
                                                                                                                                    <li><a href="javascript:;">Level
                                                                                                                                            1</a>
                                                                                                                            ...
                                                                                                                            <li>
                                                                                                                                <a href="https://dropways.github.io/deskapp-free-single-page-website-template/" target="_blank" class="dropdown-toggle no-arrow">
                                                                                                                                    ...
                                                                                                                                    <span class="mtext">Landing
                                                                                                                                        Page
                                                                                                                                        <img src="http://localhost/MS/assets/vendors/images/coming-soon.png" alt="" width="25" class="mCS_img_loaded"></span>
                                                                                                                                </a>
                                                                                                                            </li>
                                                                                                                        </ul>
                                                                                                                    </div>
                                                                                                                ...
                                                                                                                <div id="mCSB_3_scrollbar_vertical" class="mCSB_scrollTools mCSB_3_scrollbar mCS-dark-2 mCSB_scrollTools_vertical mCSB_scrollTools_onDrag_expand" style="display: block;">
                                                                                                                    <div class="mCSB_draggerContainer">
                                                                                                                        <div id="mCSB_3_dragger_vertical" class="mCSB_dragger" style="position: absolute; min-height: 872px; display: block; height: 872px; max-height: 1065.59px; top: 0px;">
                                                                                                                            <div class="mCSB_dragger_bar" style="line-height: 872px;">
                                                                                                                            </div>
                                                                                                                        </div>
                                                                                                                        <div class="mCSB_draggerRail">
                                                                                                                        </div>
...
new Vue({
  ...
  methods: {
            ...
            <div class="datepicker--content">
                <div class="datepicker--days datepicker--body active">
                    ...
                    <div class="datepicker--cells datepicker--cells-days">
                        <div class="datepicker--cell datepicker--cell-day -weekend- -other-month-" data-date="30" data-month="6" data-year="2023">30</div>
                        <div class="datepicker--cell datepicker--cell-day -other-month-" data-date="31" data-month="6" data-year="2023">31</div>
                        <div class="datepicker--cell datepicker--cell-day" data-date="1" data-month="7" data-year="2023">1</div>
                        <div class="datepicker--cell datepicker--cell-day" data-date="2" data-month="7" data-year="2023">2</div>
                        <div class="datepicker--cell datepicker--cell-day" data-date="3" data-month="7" data-year="2023">3</div>
                        <div class="datepicker--cell datepicker--cell-day" data-date="4" data-month="7" data-year="2023">4</div>
                        <div class="datepicker--cell datepicker--cell-day -weekend- -current-" data-date="5" data-month="7" data-year="2023">5</div>
                        <div class="datepicker--cell datepicker--cell-day -weekend-" data-date="6" data-month="7" data-year="2023">6</div>
                        <div class="datepicker--cell datepicker--cell-day" data-date="7" data-month="7" data-year="2023">7</div>
                        <div class="datepicker--cell datepicker--cell-day" data-date="8" data-month="7" data-year="2023">8</div>
                        <div class="datepicker--cell datepicker--cell-day" data-date="9" data-month="7" data-year="2023">9</div>
                        <div class="datepicker--cell datepicker--cell-day" data-date="10" data-month="7" data-year="2023">10</div>
                        <div class="datepicker--cell datepicker--cell-day" data-date="11" data-month="7" data-year="2023">11</div>
                        <div class="datepicker--cell datepicker--cell-day -weekend-" data-date="12" data-month="7" data-year="2023">12</div>
                        <div class="datepicker--cell datepicker--cell-day -weekend-" data-date="13" data-month="7" data-year="2023">13</div>
                        <div class="datepicker--cell datepicker--cell-day" data-date="14" data-month="7" data-year="2023">14</div>
                        <div class="datepicker--cell datepicker--cell-day" data-date="15" data-month="7" data-year="2023">15</div>
                        <div class="datepicker--cell datepicker--cell-day" data-date="16" data-month="7" data-year="2023">16</div>
                        <div class="datepicker--cell datepicker--cell-day" data-date="17" data-month="7" data-year="2023">17</div>
                        <div class="datepicker--cell datepicker--cell-day" data-date="18" data-month="7" data-year="2023">18</div>
                        <div class="datepicker--cell datepicker--cell-day -weekend-" data-date="19" data-month="7" data-year="2023">19</div>
                        <div class="datepicker--cell datepicker--cell-day -weekend-" data-date="20" data-month="7" data-year="2023">20</div>
                        <div class="datepicker--cell datepicker--cell-day" data-date="21" data-month="7" data-year="2023">21</div>
                        <div class="datepicker--cell datepicker--cell-day" data-date="22" data-month="7" data-year="2023">22</div>
                        <div class="datepicker--cell datepicker--cell-day" data-date="23" data-month="7" data-year="2023">23</div>
                        <div class="datepicker--cell datepicker--cell-day" data-date="24" data-month="7" data-year="2023">24</div>
                        <div class="datepicker--cell datepicker--cell-day" data-date="25" data-month="7" data-year="2023">25</div>
                        <div class="datepicker--cell datepicker--cell-day -weekend-" data-date="26" data-month="7" data-year="2023">26</div>
                        <div class="datepicker--cell datepicker--cell-day -weekend-" data-date="27" data-month="7" data-year="2023">27</div>
                        <div class="datepicker--cell datepicker--cell-day" data-date="28" data-month="7" data-year="2023">28</div>
                        <div class="datepicker--cell datepicker--cell-day" data-date="29" data-month="7" data-year="2023">29</div>
                        <div class="datepicker--cell datepicker--cell-day" data-date="30" data-month="7" data-year="2023">30</div>
                        <div class="datepicker--cell datepicker--cell-day" data-date="31" data-month="7" data-year="2023">31</div>
                        <div class="datepicker--cell datepicker--cell-day -other-month-" data-date="1" data-month="8" data-year="2023">1</div>
                        <div class="datepicker--cell datepicker--cell-day -weekend- -other-month-" data-date="2" data-month="8" data-year="2023">2</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="abineContentPanel" style="background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; background-color: transparent !important; margin: 0px !important; padding: 0px !important; display: none; opacity: 1 !important; z-index: 2147483647 !important; position: absolute !important; top: 20px !important; right: 20px !important; overflow: hidden !important; border-width: 0px !important; visibility: visible !important;">
        <iframe class="abineContentFrame" width="310px" allowtransparency="true" frameborder="0" height="0px" scrolling="no" src="chrome-extension://caljgklbbfbcjjanaijlacgncafpegll/html/inlineForm.html?abine14583707doNotRemove" id="abine14583707doNotRemove" position="undefined" style="display:block !important;position:relative !important;background:transparent !important;border-width:0px !important;left:0px !important;top:0px !important;visibility:visible !important;opacity:1 !important;filter:alpha(opacity:100) !important;margin:0 !important;padding:0 !important;height:0px !important;width:310px"></iframe>
    </div>
...
</body><div class="abineContentPanel" style="background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; background-color: transparent !important; margin: 0px !important; padding: 0px !important; display: none; opacity: 1 !important; z-index: 2147483647 !important; position: absolute !important; top: 20px !important; right: 20px !important; overflow: hidden !important; border-width: 0px !important; visibility: visible !important;"><iframe class="abineContentFrame" width="310px" allowtransparency="true" frameborder="0" height="0px" scrolling="no" src="chrome-extension://caljgklbbfbcjjanaijlacgncafpegll/html/inlineForm.html?abine462660doNotRemove" id="abine462660doNotRemove" position="undefined" style="display:block !important;position:relative !important;background:transparent !important;border-width:0px !important;left:0px !important;top:0px !important;visibility:visible !important;opacity:1 !important;filter:alpha(opacity:100) !important;margin:0 !important;padding:0 !important;height:0px !important;width:310px"></iframe></div></html>