...
<script src="http://cdnjs.cloudflare.com/ajax/libs/jquery-mousewheel/3.1.13/jquery.mousewheel.min.js"></script><style>@-webkit-keyframes swal2-show {
  0% {
    -webkit-transform: scale(0.7);
            transform: scale(0.7); }
  45% {
...
<body class="header-white active sidebar-dark" data-new-gr-c-s-check-loaded="14.1117.0" data-gr-ext-installed="">
    ...
    <div class="header">
        <div class="header-left">
			...
			<form abineguid="C780F692C19C4F749D52CB30B1EE8AF2">
        ...
        <div class="sidebar-title">
            ...
            <div class="close-sidebar" data-toggle="right-sidebar-close">
        ...
        </a><div class="right-sidebar-body customscroll mCustomScrollbar _mCS_2 mCS_no_scrollbar"><div id="mCSB_2" class="mCustomScrollBox mCS-light mCSB_vertical mCSB_inside" style="max-height: none;" tabindex="0"><div id="mCSB_2_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="position:relative; top:0; left:0;" dir="ltr"><a <="" a="">
            </a><div id="mCSB_2" class="mCustomScrollBox mCS-light mCSB_vertical mCSB_inside" style="max-height: none;" tabindex="0"><a <="" a="">
                </a><div id="mCSB_2_container" class="mCSB_container" style="position:relative; top:0; left:0;" dir="ltr"><a <="" a="">
                    </a><div id="mCSB_2" class="mCustomScrollBox mCS-dark-2 mCSB_vertical mCSB_inside" style="max-height: none;" tabindex="0"><a <="" a="">
                        </a><div id="mCSB_2_container" class="mCSB_container" style="position:relative; top:0; left:0;" dir="ltr"><a <="" a="">
                            </a><div class="right-sidebar-body-content"><a <="" a="">
                                <h4 class="weight-600 font-18 pb-10">Header Background</h4>
                                </a><div class="sidebar-btn-group pb-30 mb-10"><a <="" a="">
                                    <a href="javascript:void(0);" class="btn btn-outline-primary header-white active">White</a>
                                    </a><a href="javascript:void(0);" class="btn btn-outline-primary header-dark">Dark</a>
                                </div>
                        ...
                        <div id="mCSB_2_scrollbar_vertical" class="mCSB_scrollTools mCSB_2_scrollbar mCS-dark-2 mCSB_scrollTools_vertical mCSB_scrollTools_onDrag_expand" style="display: none;">
                            <div class="mCSB_draggerContainer">
                                <div id="mCSB_2_dragger_vertical" class="mCSB_dragger" style="position: absolute; min-height: 573px; display: block; height: 0px; max-height: 593.97px; top: 0px;">
                                    <div class="mCSB_dragger_bar" style="line-height: 573px;"></div>
                                </div>
                                <div class="mCSB_draggerRail"></div>
                            </div>
                        </div>
                ...
                <div id="mCSB_3_container" class="mCSB_container" style="position:relative; top:0; left:0;" dir="ltr">
                    <div id="mCSB_3" class="mCustomScrollBox mCS-dark-2 mCSB_vertical mCSB_inside" style="max-height: none;" tabindex="0">
                        ...
                        <div id="mCSB_3_scrollbar_vertical" class="mCSB_scrollTools mCSB_3_scrollbar mCS-dark-2 mCSB_scrollTools_vertical mCSB_scrollTools_onDrag_expand" style="display: block;">
                            <div class="mCSB_draggerContainer">
                                <div id="mCSB_3_dragger_vertical" class="mCSB_dragger" style="position: absolute; min-height: 591px; display: block; height: 872px; max-height: 1065.59px; top: 0px;">
                                    <div class="mCSB_dragger_bar" style="line-height: 591px;"></div>
                                </div>
                                <div class="mCSB_draggerRail"></div>
                            </div>
                        </div>
    ...
    <div class="buttons">
        <!-- Update the href attribute to include the project ID -->
                <!-- Update the href attribute to include the project ID -->
        <a class="btn btn-edit" href="http://localhost/MS/deskapp/ui/editProject/2">Edit
            <!-- Display the project name -->          
        </a>
     
        <button class="btn btn-view" onclick="window.location.href='http://localhost/MS/deskapp/ui/buttons'">View</button>
    </div>
</div>
                </div>
            </div>
