...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="http://localhost/MS/assets/src/plugins/datatables/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet" type="text/css"
        href="http://localhost/MS/assets/src/plugins/datatables/css/responsive.bootstrap4.min.css">
...
<body class="header-white active sidebar-dark" data-new-gr-c-s-check-loaded="14.1117.0" data-gr-ext-installed="">
                            ...
                            <div class="sidebar-menu icon-style-2 icon-list-style-1">
                                <ul id="accordion-menu">
                                    <li class="dropdown">
                                        ...
                                        <ul class="submenu">
                                            <li><a href="http://localhost/MS/deskapp/dashboard">Dashboard System
                                                    Manger</a></li>
                                            <li><a href="http://localhost/MS/deskapp/dashboard/two">Dashboard Manger</a>
                                            </li>
                        ...
                        <div id="mCSB_3_scrollbar_vertical"
                            ...
                            <div class="mCSB_draggerContainer">
                                <div id="mCSB_3_dragger_vertical" class="mCSB_dragger"
                                    style="position: absolute; min-height: 707px; display: block; height: 872px; max-height: 1065.59px; top: 0px;">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    ...
                    <nav aria-label="breadcrumb" role="navigation">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="http://localhost/MS/deskapp/dashboard/two">Dashboard
                                    Manger</a></li>
    ...
    $startIndex = max(0, count($project_data['pro_name']) - 2);
