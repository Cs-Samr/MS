...
<body class="header-white active sidebar-dark" data-new-gr-c-s-check-loaded="14.1117.0" data-gr-ext-installed="">
    ...
    <div class="left-side-bar open">
        ...
        <div class="menu-block customscroll mCustomScrollbar _mCS_3">
            <div id="mCSB_3" class="mCustomScrollBox mCS-dark-2 mCSB_vertical mCSB_inside" style="max-height: none;"
                tabindex="0">
                            ...
                            <li>
                                <a href="https://dropways.github.io/deskapp-free-single-page-website-template/"
                                    ...
                                    <span class="mtext">Landing Page <img
                                            src="http://localhost/MS/assets/vendors/images/coming-soon.png" alt=""
                                            width="25" class="mCS_img_loaded"></span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <div id="mCSB_3_scrollbar_vertical"
                    ...
                    <div class="mCSB_draggerContainer">
                        <div id="mCSB_3_dragger_vertical" class="mCSB_dragger"
                            style="position: absolute; min-height: 30px; display: block; height: 707px; max-height: 862px; top: 0px;">
