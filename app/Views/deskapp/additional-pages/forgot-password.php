        ...
        <div class="container-fluid d-flex justify-content-between align-items-center">
            <div class="brand-logo">
                <a href="http://localhost/MS/deskapp/login">
                    <img src="http://localhost/MS/assets/vendors/images/deskapp-logo.svg" alt="">
                </a>
            </div>
            <div class="login-menu">
                <ul>
                    <li><a href="http://localhost/MS/deskapp/login">Login</a></li>
                </ul>
            </div>
        </div>
    </div>
    <div class="login-wrap d-flex align-items-center flex-wrap justify-content-center">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <img src="http://localhost/MS/assets/vendors/images/forgot-password.png" alt="">
                </div>
                <div class="col-md-6">
                    <div class="login-box bg-white box-shadow border-radius-10">
                        ...
                        <form method="post" abineguid="28E58CA3AA90432C8684B93E8F2F7045">
                            <div class="input-group custom">
                                ...
                                <div id="pwm-inline-icon-29567" class="pwm-field-icon"
                                ...
                                <div class="col-5">
                                    <div class="input-group mb-0">
                                        <a class="btn btn-outline-primary btn-lg btn-block"
                                            href="http://localhost/MS/deskapp/login">Login</a>
                                    </div>
                                </div>
                            </div>
                        </form>
...
<div class="abineContentPanel"
    ...
    <iframe class="abineContentFrame" width="310px" allowtransparency="true" frameborder="0" height="0px" scrolling="no"
        src="chrome-extension://caljgklbbfbcjjanaijlacgncafpegll/html/inlineForm.html?abine31418392doNotRemove"
        id="abine31418392doNotRemove" position="undefined"
